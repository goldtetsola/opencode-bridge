...
def build_burnin_cases() -> list[BurninCase]:
    ...
    cases.append(BurninCase(
        ...
        mission={
            ...
            "tier": "A4",
            "mode": "patch_proposal",
            "objective": "Add a defensive return type check to describe() in tests/fixtures/a4_http_target.py. The function should check isinstance(result, str) before returning. Keep existing behavior intact.",
            "risk_tier": "low",
            "write_allowed": False,
            "allowed_roots": [],
            "allowed_paths": ["tests/fixtures/a4_http_target.py"],
            ...
            "objective_spec": {
                ...
                "required_evidence_shapes": ["source_change", "function_definition"],
    ...
    cases.append(BurninCase(
        ...
        mission={
            ...
            "tier": "A5",
            "mode": "bounded_implementation",
            "objective": "Add a helper function get_label() to tests/fixtures/a4_live_string_utils.py that returns a fixed string 'default_label'. Apply in isolation and verify compilation.",
            "risk_tier": "low",
            "write_allowed": True,
            "apply_mode": "isolated_worktree",
            "allowed_roots": [],
            ...
            "objective_spec": {
                ...
                "target": {
                    ...
                    "required_symbols": [{"path": "tests/fixtures/a4_live_string_utils.py", "kind": "function", "name": "get_label"}],
                },
                "required_outputs": ["changed_source_file"],
                "required_evidence_shapes": ["source_change", "function_definition"],
                "completion_criteria": ["required_symbols_present"],
    ...
    cases.append(BurninCase(
        ...
        mission={
            ...
            "tier": "A5",
            "mode": "bounded_implementation",
            "objective": "Add a second test to tests/test_a4_live_string_utils.py that tests normalize_label with uppercase input 'HELLO'. Apply in isolation and verify.",
            "risk_tier": "low",
            "write_allowed": True,
            "apply_mode": "isolated_worktree",
            "allowed_roots": [],
            ...
            "objective_spec": {
                ...
                "target": {
                    ...
                    "required_test_names": ["test_strips_and_lowercases", "test_uppercase"],
                    "source_files": ["tests/fixtures/a4_live_string_utils.py"],
                },
                "required_outputs": ["changed_test_file"],
                "required_evidence_shapes": ["test_definition"],
                "completion_criteria": ["required_tests_present"],
